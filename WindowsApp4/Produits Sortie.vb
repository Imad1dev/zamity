...
Public Class Produits_Sortie
    ...
    Private Sub LoadReceptionData()
        Dim query As String = "SELECT BL, Palette, BR, Poids, Varietes, NombresdeCaisses, Clients FROM Reception"
    ...
    Private Sub TextBox1_TextChanged(sender As Object, e As EventArgs) Handles TextBox1.TextChanged
        Dim filter As String = String.Format("Palette LIKE '%{0}%'", TextBox1.Text)
