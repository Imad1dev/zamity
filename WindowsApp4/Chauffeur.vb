...
Public Class Chauffeur
    ...
    ' Method to load data from the Chauffeur table and bind it to the DataGridView
    Private Sub LoadChauffeurData()
        Dim query As String = "SELECT Nom, Prenom, Matricule FROM Chauffeur"
    ...
    Private Sub TextBox1_TextChanged(sender As Object, e As EventArgs) Handles TextBox1.TextChanged
        Dim filter As String = String.Format("Nom LIKE '%{0}%'", TextBox1.Text)
