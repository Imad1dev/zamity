...
Public Class Rayonnage_ADD
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Else
            ...
            Dim insertQuery As String = "INSERT INTO Rayonnage (Rayonnage) " & "VALUES (?)"

            ' Create parameters
            Dim parameters As OleDbParameter() = {
            New OleDbParameter("@Rayonnage", TextBox1.Text)
        }
    ...
    Private Sub Ferme_Load(sender As Object, e As EventArgs) Handles MyBase.Load
